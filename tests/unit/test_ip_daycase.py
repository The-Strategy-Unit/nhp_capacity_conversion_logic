...
from nhp.capacity_conversion.ip_daycase import (
    convert_ip_daycase_capacity,
    calculate_ip_daycase_capacity,
    main,
)
...
def test_calculate_ip_daycase_capacity(mocker, caplog):
    # arrange
    ...
    mock_convert = mocker.patch(
        "nhp.capacity_conversion.ip_daycase.convert_ip_daycase_capacity",
        return_value=999,
    )
